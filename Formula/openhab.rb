...
class Openhab < Formula
  ...
  url "https://openhab.jfrog.io/artifactory/libs-release-local/org/openhab/distro/openhab/5.1.3/openhab-5.1.3.tar.gz"
  sha256 "a435e4749efe237a172c7fd8b4a91c68b21461c8a4356037ca75e7c6292d7b38"
  license "EPL-2.0"
  ...
  def caveats
    <<~EOS
      ...
      To install the add-ons KAR for offline use:
        curl -L --output-dir #{openhab_addons} -o openhab-addons-5.1.3.kar https://openhab.jfrog.io/artifactory/libs-release-local/org/openhab/distro/openhab-addons/5.1.3/openhab-addons-5.1.3.kar
      To verify its checksum:
        echo "c532003033529a1e7e37021d10ac05a662cca9d36715bf13e7b9cfad043eeae6 #{openhab_addons}/openhab-addons-5.1.3.kar" | sha256sum -c -
    EOS
  end
